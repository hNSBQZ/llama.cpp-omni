...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_QUANTIZATION_DAMP_PERCENT,     "%s.quantization.damp_percent"     },
    { LLM_KV_QUANTIZATION_DESC_ACT,         "%s.quantization.desc_act"         },
    { LLM_KV_QUANTIZATION_STATIC_GROUPS,    "%s.quantization.static_groups"    },
    { LLM_KV_QUANTIZATION_SYM,              "%s.quantization.sym"              },
    { LLM_KV_QUANTIZATION_TRUE_SEQUENTIAL,  "%s.quantization.true_sequential"  },
    { LLM_KV_QUANTIZATION_CHECKPOINT_FORMAT,"%s.quantization.checkpoint_format"},
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_QWEN3,
        {
            ...
            { LLM_TENSOR_ATTN_Q_GPTQ_QWEIGHT, "llm.model.layers.%d.self_attn.q_proj.qweight" },
            { LLM_TENSOR_ATTN_Q_GPTQ_QZEROS,  "llm.model.layers.%d.self_attn.q_proj.qzeros" },
            { LLM_TENSOR_ATTN_Q_GPTQ_SCALES,  "llm.model.layers.%d.self_attn.q_proj.scales" },
            { LLM_TENSOR_ATTN_Q_GPTQ_G_IDX,   "llm.model.layers.%d.self_attn.q_proj.g_idx" },
            { LLM_TENSOR_ATTN_Q_NORM,     "blk.%d.attn_q_norm" },
            { LLM_TENSOR_ATTN_K,          "blk.%d.attn_k" },
            ...
            { LLM_TENSOR_ATTN_K_GPTQ_QWEIGHT, "llm.model.layers.%d.self_attn.k_proj.qweight" },
            { LLM_TENSOR_ATTN_K_GPTQ_QZEROS,  "llm.model.layers.%d.self_attn.k_proj.qzeros" },
            { LLM_TENSOR_ATTN_K_GPTQ_SCALES,  "llm.model.layers.%d.self_attn.k_proj.scales" },
            { LLM_TENSOR_ATTN_K_GPTQ_G_IDX,   "llm.model.layers.%d.self_attn.k_proj.g_idx" },
            { LLM_TENSOR_ATTN_K_NORM,     "blk.%d.attn_k_norm" },
            { LLM_TENSOR_ATTN_V,          "blk.%d.attn_v" },
            ...
            { LLM_TENSOR_ATTN_V_GPTQ_QWEIGHT, "llm.model.layers.%d.self_attn.v_proj.qweight" },
            { LLM_TENSOR_ATTN_V_GPTQ_QZEROS,  "llm.model.layers.%d.self_attn.v_proj.qzeros" },
            { LLM_TENSOR_ATTN_V_GPTQ_SCALES,  "llm.model.layers.%d.self_attn.v_proj.scales" },
            { LLM_TENSOR_ATTN_V_GPTQ_G_IDX,   "llm.model.layers.%d.self_attn.v_proj.g_idx" },
            { LLM_TENSOR_ATTN_OUT,        "blk.%d.attn_output" },
            ...
            { LLM_TENSOR_ATTN_OUT_GPTQ_QWEIGHT, "llm.model.layers.%d.self_attn.o_proj.qweight" },
            { LLM_TENSOR_ATTN_OUT_GPTQ_QZEROS,  "llm.model.layers.%d.self_attn.o_proj.qzeros" },
            { LLM_TENSOR_ATTN_OUT_GPTQ_SCALES,  "llm.model.layers.%d.self_attn.o_proj.scales" },
            { LLM_TENSOR_ATTN_OUT_GPTQ_G_IDX,   "llm.model.layers.%d.self_attn.o_proj.g_idx" },
            { LLM_TENSOR_FFN_NORM,        "blk.%d.ffn_norm" },
            { LLM_TENSOR_FFN_GATE,        "blk.%d.ffn_gate" },
            ...
            { LLM_TENSOR_FFN_GATE_GPTQ_QWEIGHT, "llm.model.layers.%d.mlp.gate_proj.qweight" },
            { LLM_TENSOR_FFN_GATE_GPTQ_QZEROS,  "llm.model.layers.%d.mlp.gate_proj.qzeros" },
            { LLM_TENSOR_FFN_GATE_GPTQ_SCALES,  "llm.model.layers.%d.mlp.gate_proj.scales" },
            { LLM_TENSOR_FFN_GATE_GPTQ_G_IDX,   "llm.model.layers.%d.mlp.gate_proj.g_idx" },
            { LLM_TENSOR_FFN_DOWN,        "blk.%d.ffn_down" },
            ...
            { LLM_TENSOR_FFN_DOWN_GPTQ_QWEIGHT, "llm.model.layers.%d.mlp.down_proj.qweight" },
            { LLM_TENSOR_FFN_DOWN_GPTQ_QZEROS,  "llm.model.layers.%d.mlp.down_proj.qzeros" },
            { LLM_TENSOR_FFN_DOWN_GPTQ_SCALES,  "llm.model.layers.%d.mlp.down_proj.scales" },
            { LLM_TENSOR_FFN_DOWN_GPTQ_G_IDX,   "llm.model.layers.%d.mlp.down_proj.g_idx" },
            { LLM_TENSOR_FFN_UP,          "blk.%d.ffn_up" },
            ...
            { LLM_TENSOR_FFN_UP_GPTQ_QWEIGHT, "llm.model.layers.%d.mlp.up_proj.qweight" },
            { LLM_TENSOR_FFN_UP_GPTQ_QZEROS,  "llm.model.layers.%d.mlp.up_proj.qzeros" },
            { LLM_TENSOR_FFN_UP_GPTQ_SCALES,  "llm.model.layers.%d.mlp.up_proj.scales" },
            { LLM_TENSOR_FFN_UP_GPTQ_G_IDX,   "llm.model.layers.%d.mlp.up_proj.g_idx" },
        },
    },
    {
        LLM_ARCH_QWEN3MOE,
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_Q_GPTQ_QWEIGHT,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_Q_GPTQ_QZEROS,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_Q_GPTQ_SCALES,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_Q_GPTQ_G_IDX,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_ATTN_K_GPTQ_QWEIGHT,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_GPTQ_QZEROS,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_GPTQ_SCALES,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_GPTQ_G_IDX,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_ATTN_V_GPTQ_QWEIGHT,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_GPTQ_QZEROS,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_GPTQ_SCALES,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_GPTQ_G_IDX,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_ATTN_OUT_GPTQ_QWEIGHT,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_OUT_GPTQ_QZEROS,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_OUT_GPTQ_SCALES,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_OUT_GPTQ_G_IDX,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_FFN_GATE_GPTQ_QWEIGHT,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE_GPTQ_QZEROS,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE_GPTQ_SCALES,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE_GPTQ_G_IDX,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_FFN_DOWN_GPTQ_QWEIGHT,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN_GPTQ_QZEROS,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN_GPTQ_SCALES,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN_GPTQ_G_IDX,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_FFN_UP_GPTQ_QWEIGHT,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP_GPTQ_QZEROS,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP_GPTQ_SCALES,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP_GPTQ_G_IDX,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
